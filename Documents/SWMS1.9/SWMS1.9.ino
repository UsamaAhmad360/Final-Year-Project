...
void checkWaterLevelAndPumpStatus() {
  ...
  // Map the distance values to the desired range (100-0)
  int waterLevelPercent = map(distance, minWaterLevel, maxWaterLevel, 100, 0);
